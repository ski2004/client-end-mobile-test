export default  {
    'Game':{
        ...
        2: {title:'Super 彩球',i_class:'far fa-dot-circle', route:'game/lottery'},
        3: {title:'皇家視訊',i_class:'fas fa-dice', route:'/game/royal'},
        4: {title:'BingoBingo',i_class:'fas fa-dharmachakra', route:'/game/bingo'},
    },
    'Watch':{
